...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<form action="../member/joinProcess" method="post" class="join"
			...
			<div class="col-6">
				<div class="input-group mb-3">
					<input type="text" name="userId"
						class="form-control form-control-lg userId" id="floatingInput"
				...
				<div class="mb-3">
					<label for="floatingPassword">Password 확인</label> <input
				...
				<div class="mb-3">
					<label for="floatingEmail">Email</label> <input type="text"
						name="userEmail" class="form-control" id="floatingEmail"
  ...
  function searchZonecode() {
    new daum.Postcode({
      oncomplete: function (data) {
        ...
        document.querySelector("#zonecode").value = data.zonecode; // 값이들어가는 부분
