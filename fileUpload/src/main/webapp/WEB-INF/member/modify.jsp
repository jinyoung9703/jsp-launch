...
<form action="../member/modifyProcess" method="post" class="join"
	name="joinForm">
			...
			<div class="col-6">
				<div class="input-group mb-3">
					<input type="text" name="userId" class="form-control userId"
						id="floatingInput" placeholder="아이디를 입력해 주세요." readonly
